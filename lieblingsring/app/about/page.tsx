    ...
    <section className="bias-left" style={{ padding: "24px 0" }}>
      ...
      <article>
        ...
        <p style={{ whiteSpace: "pre-line", lineHeight: 1.7 }}>
          리블링스링(Lieblingsring)은 독일어 단어로 &apos;가장 좋아하는 반지&apos;라는 의미입니다.
        ...
        <div style={{ marginTop: 20, border: "1px solid #e5e7eb", borderRadius: 10, padding: 16 }}>
          ...
          <div className="muted" style={{ marginTop: 6 }}>
            <div>
              <a href="tel:01026080967">010-2608-0967</a> ·{" "}
              <a href="mailto:lieblingsring@naver.com">lieblingsring@naver.com</a>
            </div>
            <div style={{ marginTop: 6 }}>평일 10:00~16:00, 주말/공휴일 휴무</div>
          </div>
        </div>
      </article>
      <div /> {/* 오른쪽 여백 */}
